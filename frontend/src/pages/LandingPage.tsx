  ...
  return (
    <header className="sticky top-0 z-50 px-4 pt-4">
      <nav className="mx-auto flex max-w-6xl items-center justify-between rounded-2xl border border-stone-200/70 bg-white/90 px-6 py-3 shadow-sm backdrop-blur">
        <Link to="/" className="flex items-center text-2xl font-bold tracking-tight text-ink">
          rely
        ...
        <div className="flex items-center gap-7 text-sm text-stone-600">
          ...
          <Link to="/app" className="hidden items-center gap-1 text-ink hover:text-stone-600 sm:inline-flex">
  ...
  return (
    <section className="mx-auto max-w-4xl px-6 py-24 text-center">
      ...
      <div className="mt-9 flex items-center justify-center gap-3">
        ...
        <Link
          to="/app"
          className="inline-flex items-center gap-1.5 rounded-lg border border-stone-200 bg-white px-5 py-3 text-sm font-medium text-ink transition hover:bg-stone-50"
        >
          Launch the app
